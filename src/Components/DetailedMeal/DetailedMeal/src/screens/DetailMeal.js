    ...
    <ScrollView style={styles.container}>
      ...
      <View>
        ...
        <View style={{ flexDirection: "row", marginVertical: 20 }}>
          <Text style={{ fontWeight: "bold", fontSize: 35, marginLeft: wp("10%"), flex: 5 }}>
            {mealInfo.name}
          </Text>
        ...
        <View style={{ flexDirection: "row", marginVertical: 20 }}>
          ...
          <TouchableOpacity style={{ backgroundColor: "#a1c559", width: wp("20%"), alignItems: "center", padding: 10, borderRadius: 10, position: "absolute", alignSelf: "center", right: wp("1%") }}
            onPress={addToCart}>
        ...
        <View style={{ flexDirection: "row", marginBottom: hp("2%") }}>
          ...
          <TouchableOpacity style={{ backgroundColor: "#a1c559", width: wp("20%"), alignItems: "center", marginLeft: wp("5%"), padding: 10, borderRadius: 10, position: "absolute", right: wp("1%") }}
      ...
      <View style={{ padding: 30, paddingTop: 20, paddingBottom: 5 }}>
        <Text style={{
          color: "rgba(0,0,0,1)", fontSize: 19, fontFamily: "roboto-300"}}>{mealInfo.description}</Text>
      </View>
      
      <View style={{ borderBottomColor: 'black', borderBottomWidth: 1,}}/>

      <View style={{ justifyContent: "space-evenly", padding: 10, flexDirection: "row" }}>
        <TouchableOpacity onPress={NutritionInfo}
          style={tabSelected.nutrition ? { backgroundColor: "black" } : {}}>
          <Text style={{ color: "rgba(106,164,27,1)", fontSize: 18, fontFamily: "roboto-900" }}>Nutrition</Text>
        </TouchableOpacity>
        
        <TouchableOpacity onPress={IngredientsList}
          style={tabSelected.ingredients ? { backgroundColor: "black" } : {}}>
          <Text style={{ color: "rgba(106,164,27,1)", fontSize: 18, fontFamily: "roboto-900"}}>Ingredients</Text>
        </TouchableOpacity>
       
        <TouchableOpacity onPress={ProcedureInfo}
          style={tabSelected.procedure ? { backgroundColor: "black" } : {}}>
          <Text style={{ color: "rgba(106,164,27,1)", fontSize: 18, fontFamily: "roboto-900"}}>Recipe/Procedure</Text>
        </TouchableOpacity>
      </View>
