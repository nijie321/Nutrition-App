...
import { ParamListBase, Descriptor, NavigationHelpers, Route, NavigationProp, TabNavigationState } from '@react-navigation/native';
...
export declare type MaterialTopTabNavigationHelpers = NavigationHelpers<ParamListBase, MaterialTopTabNavigationEventMap>;
export declare type MaterialTopTabNavigationProp<ParamList extends ParamListBase, RouteName extends keyof ParamList = string> = NavigationProp<ParamList, RouteName, TabNavigationState, MaterialTopTabNavigationOptions, MaterialTopTabNavigationEventMap> & {
    /**
...
export declare type MaterialTopTabDescriptor = Descriptor<ParamListBase, string, TabNavigationState, MaterialTopTabNavigationOptions>;
export declare type MaterialTopTabDescriptorMap = {
    [key: string]: MaterialTopTabDescriptor;
};
export declare type MaterialTopTabNavigationConfig = Partial<Omit<React.ComponentProps<typeof TabView>, 'navigationState' | 'onIndexChange' | 'onSwipeStart' | 'onSwipeEnd' | 'renderScene' | 'renderTabBar' | 'renderPager' | 'renderLazyPlaceholder'>> & {
    /**
...
export declare type MaterialTopTabBarOptions = Partial<Omit<React.ComponentProps<typeof TabBar>, 'navigationState' | 'activeColor' | 'inactiveColor' | 'renderLabel' | 'renderIcon' | 'getLabelText' | 'getAccessibilityLabel' | 'getTestID' | 'onTabPress' | 'onTabLongPress' | keyof SceneRendererProps>> & {
    /**
...
export declare type MaterialTopTabBarProps = MaterialTopTabBarOptions & SceneRendererProps & {
