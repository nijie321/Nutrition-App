...
function MaterialTopTabView(_ref) {
  let {
    pager,
    lazyPlaceholder,
    tabBar = props => React.createElement(_MaterialTopTabBar.default, props),
    tabBarOptions,
    state,
    navigation,
    descriptors,
  ...
  const renderTabBar = props => {
    return tabBar(_objectSpread({}, tabBarOptions, {}, props, {
      state: state,
  ...
  return React.createElement(_reactNativeTabView.TabView, _extends({}, rest, {
    onIndexChange: index => navigation.dispatch(_objectSpread({}, _native.TabActions.jumpTo(state.routes[index].name), {
      target: state.key
    })),
    renderScene: (_ref2) => {
      let {
