...
const MISSING_CONTEXT_ERROR = "Couldn't find a navigation context. Have you wrapped your app with 'NavigationContainer'? See https://reactnavigation.org/docs/getting-started.html for setup instructions.";
const NOT_INITIALIZED_ERROR = "The 'navigation' object hasn't been initialized yet. This might happen if you don't have a navigator mounted, or if the navigator hasn't finished mounting. See https://reactnavigation.org/docs/navigating-without-navigation-prop.html#handling-initialization for more details.";
...
const BaseNavigationContainer = React.forwardRef(function BaseNavigationContainer(_ref, ref) {
  let {
    initialState,
    onStateChange,
    independent,
  ...
  const [state, getState, setState] = (0, _useSyncState.default)(() => getPartialState(initialState == null ? undefined : initialState));
  ...
  React.useImperativeHandle(ref, () => _objectSpread({}, Object.keys(_routers.CommonActions).reduce((acc, name) => {
    acc[name] = function () {
      return dispatch(_routers.CommonActions[name]( // @ts-ignore
      ...arguments));
    };
