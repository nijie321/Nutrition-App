...
class DrawerView extends React.PureComponent {
  constructor() {
    ...
    _defineProperty(this, "isGestureEnabled", new Value(this.props.gestureEnabled ? TRUE : FALSE));
  ...
  render() {
    ...
    return React.createElement(_reactNativeGestureHandler.PanGestureHandler, _extends({
      ref: onGestureRef,
    ...
    })), React.createElement(_reactNativeGestureHandler.TapGestureHandler, {
      enabled: gestureEnabled,
