...
export default class HeaderSegment extends React.Component {
  ...
  render() {
    const {
      ...
      headerLeft: left = onGoBack ? props => React.createElement(HeaderBackButton, props) : undefined,
      headerTransparent,
      headerTintColor,
      headerBackground,
      headerRight: right,
    ...
    const _ref2 = StyleSheet.flatten(customHeaderStyle || {}),
          {
    ...
    })), right ? React.createElement(Animated.View, {
      pointerEvents: "box-none",
      style: [styles.right, {
        right: insets.right
