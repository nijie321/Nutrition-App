...
class HeaderSegment extends React.Component {
  ...
  render() {
    const {
      ...
      headerLeft: left = onGoBack ? props => React.createElement(_HeaderBackButton.default, props) : undefined,
      headerTransparent,
      headerTintColor,
      headerBackground,
      headerRight: right,
    ...
    const _ref2 = _reactNative.StyleSheet.flatten(customHeaderStyle || {}),
          {
